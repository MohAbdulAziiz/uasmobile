...
export default function AdminLayout({ children }) {
  ...
  const navItems = [
    ...
    { name: 'Users', icon: Users, path: '/admin/user' },
    { name: 'Produk', icon: Folder, path: '/admin/produk' },
    { name: 'Pembelian', icon: ShoppingBag, path: '/admin/pembelian' },
    { name: 'Laporan', icon: Calendar, path: '/admin/laporan' },
      ...
      <div className="absolute right-0 top-12 bg-white text-black rounded shadow-lg w-40 py-2 z-50">
        <button
          ...
          onClick={() => {
            ...
            router.push('/admin/profile') // arahkan ke halaman profil
          }}
        >
          Profil
        </button>
